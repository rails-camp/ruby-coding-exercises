...
describe ContentSorter do
  it 'shuffles text based content and splits it by section length and delimiters' do
    ...
    expected_result = ["Chuck Norris' addition operator doesn't commute;", " it teleports to where he needs it to be.", "Chuck Norris doesn't have performance bottlenecks.", " the method loses.Chuck Norris'sfirst program was kill -9.", " he blows them away.", "Whiteboards are white because Chuck Norris scared them that way.", "Chuck Norris doesn't delete files,", "No statement can catch the ChuckNorrisException.", " the languagechanges itself to accommodate Chuck Norris.", " Backwards.When Chuck Norris gives a method an argument,", "Chuck Norris can recite π.", "Chuck Norris doesn't get compiler errors,", " He justmakes the universe wait its turn."]
